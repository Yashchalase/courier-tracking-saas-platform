...
const COMPANY_NAV = [
  {
    ...
    match: (path: string) =>
      path === "/dashboard/company" || path === "/dashboard/company/",
  },
  {
    href: "/dashboard/company/shipments",
    label: "Shipments",
    icon: Package,
    match: (path: string) => path.startsWith("/dashboard/company/shipments"),
  },
  {
    href: "/dashboard/company/hubs",
    label: "Hubs",
    icon: Warehouse,
    match: (path: string) => path.startsWith("/dashboard/company/hubs"),
  },
  {
    href: "/dashboard/company/agents",
    label: "Agents",
    icon: Users,
    match: (path: string) => path.startsWith("/dashboard/company/agents"),
  },
  {
    href: "/dashboard/company/live-map",
    label: "Live map",
    icon: Map,
    match: (path: string) => path.startsWith("/dashboard/company/live-map"),
  },
] as const;
            ...
            <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
              ...
              <SheetContent side="left" className="w-72 border-border/80 p-0">
                <SheetHeader className="flex flex-row items-center gap-2 border-b border-border/80 px-4 py-3 text-left">
                  ...
                  <SheetTitle className="text-base">Company console</SheetTitle>
                </SheetHeader>
                <div className="p-3">
