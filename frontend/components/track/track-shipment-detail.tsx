...
export type PublicTrackShipment = {
  trackingId: string;
  status: string;
...
type TrackShipmentDetailProps = {
  trackingId: string;
  /** If set, renders a link; otherwise uses browser history back. */
  backHref?: string;
  backLabel?: string;
};

export function TrackShipmentDetail({
  trackingId,
  backHref,
  backLabel = "Back",
}: TrackShipmentDetailProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl space-y-6 pb-8 sm:pb-12">
