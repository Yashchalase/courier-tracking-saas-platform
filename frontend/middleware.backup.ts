...
type KnownDashboardRole = "SUPER_ADMIN" | "COMPANY_ADMIN" | "DELIVERY_AGENT" | "CUSTOMER";
const ROLE_DASHBOARD_HOME: Record<KnownDashboardRole, string> = {
  SUPER_ADMIN: "/dashboard/admin",
  COMPANY_ADMIN: "/dashboard/company",
  DELIVERY_AGENT: "/dashboard/agent",
  CUSTOMER: "/dashboard/customer",
};
function getRoleRequiredForDashboardPath(pathname: string): KnownDashboardRole | null {
